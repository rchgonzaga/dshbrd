        ...
        return (
            <div>
                ...
                {api.state.isLoadingSession === false ? (
                    <div>
                        <h2>
                            Dashboard - <span style={{ color: 'grey' }}>01/06/2018 ~ {(new Date()).toLocaleDateString("pt-BR")}</span>
                            &nbsp;&nbsp; | &nbsp;&nbsp; Last update: <span style={{ color: 'grey' }}> {(new Date()).toLocaleDateString("pt-BR")} &nbsp;&nbsp;
                            <Button primary onClick={() => globalApi.changeAiMothaFocka()}>Update</Button>
...
//     )
// }
const Home = () => <ApiSubscribe to={[Api, HomeApi]}>{
